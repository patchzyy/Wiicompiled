# Normalizes the Retro Rewind distribution into the layout the translator and
# the runtime expect:
#
#   RetroRewind6/
...
#
# The upstream zip spells these differently (RetroRewind6/ + Riivolution/*.xml),
# so this derivation locates the pieces and re-lays them out. If a future pack
# moves things around, this is the one place to adjust.
{
  lib,
  stdenvNoCC,
  unzip,
